...
const services = [
  {
    ...
    title: "Ansiedade",
    description:
      "Compreensão e manejo dos sintomas de ansiedade, buscando formas de lidar com as demandas do cotidiano de maneira mais equilibrada.",
    color: "bg-primary/10",
  },
  {
    icon: Heart,
    title: "Depressão",
    description:
      "Acompanhamento acolhedor para elaboração do sofrimento emocional, resgate de sentido e reconstrução do bem-estar.",
    color: "bg-mint/20",
  },
  {
    icon: Sparkles,
    ...
    description:
      "Trabalho terapêutico voltado à compreensão das origens dos medos e inseguranças, promovendo maior segurança e autonomia.",
    color: "bg-sage-light",
  },
  {
    icon: HeartHandshake,
    ...
    description:
      "Espaço de escuta e elaboração para lidar com emoções intensas, promovendo autoconhecimento e regulação emocional.",
    color: "bg-accent",
  },
  {
    icon: Users,
    ...
    description:
      "Reflexão sobre padrões relacionais, comunicação e construção de vínculos mais saudáveis e conscientes.",
    color: "bg-primary/10",
  },
  {
    icon: Flower2,
    ...
    description:
      "Jornada de descoberta pessoal para compreender sua história, seus valores e construir novos caminhos de vida.",
    color: "bg-mint/20",
  },
];
...
const ServicesSection = ({ onScheduleClick }: ServicesSectionProps) => {
  return (
    <section
      id="servicos"
      className="relative py-20 lg:py-32 bg-gradient-to-b from-background via-mint-light/30 to-background overflow-hidden"
    >
      <AnimatedLeaves />
        ...
        <ScrollReveal delay={0.3} className="text-center mt-16">
          <div className="inline-block p-8 bg-card rounded-3xl shadow-lg border">
            ...
            <Button
              ...
              className="rounded-full px-8 py-6 text-lg shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse-scale hover:animate-none hover:scale-105"
            >
